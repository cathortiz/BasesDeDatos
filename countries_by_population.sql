/*
 Top 100 países por población, 2014
 By https://www.khanacademy.org/profile/darrylyeo/
 */

CREATE TABLE poblacion_paises (
    posicion INTEGER PRIMARY KEY AUTOINCREMENT,
    pais TEXT,
    poblacion INTEGER,
    cambio_en_un_anio_porc NUMERIC,
    cambio_poblacion INTEGER,
    neto_migrantes INTEGER,
    edad_promedio NUMERIC,
    porc_mayores_60 INTEGER,
    ratio_fertilidad NUMERIC,
    area_sq_km INTEGER,
    densidad_sq_km INTEGER,
    pob_urbana_porc INTEGER,
    pob_urbana INTEGER,
    porc_pob_mundial NUMERIC
);
    
INSERT INTO poblacion_paises (pais, poblacion, cambio_en_un_anio_porc, cambio_poblacion, neto_migrantes, edad_promedio, porc_mayores_60, ratio_fertilidad, area_sq_km, densidad_sq_km, pob_urbana_porc, pob_urbana, porc_pob_mundial) VALUES (
